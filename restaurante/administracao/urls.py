...
urlpatterns = [
    ...
    re_path(r'^cardapio/hub/$', views.MenuGestaoCardapio, name='MenuCardapioHub'),
    ...
    re_path(r'^permissoes/$', views.GerenciarPermissoes, name='GerenciarPermissoes'),
    re_path(r'^permissoes/exportar/$', views.ExportarPermissoesJSON, name='ExportarPermissoesJSON'),
    re_path(r'^permissoes/importar/$', views.ImportarPermissoesJSON, name='ImportarPermissoesJSON'),
]