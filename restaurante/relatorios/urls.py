...
urlpatterns = [
    ...
    re_path(r'^relatorioservidores/$', views.RelatorioVendasServidor, name='RelatorioVendasServidor'),
    re_path(r'^pdfvendasservidor/$', views.PdfVendasServidor, name='PdfVendasServidor'),
]